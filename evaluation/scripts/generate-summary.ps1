...
$summaryLines.Add("---")
if ($GitHubRunUrl) {
    $summaryLines.Add("*Generated by Copilot Skills Evaluation Pipeline | [View workflow run]($GitHubRunUrl)*")
} else {
    $summaryLines.Add("*Generated by Copilot Skills Evaluation Pipeline*")
}
